...
void MyGLWidget::projectTransform () {
  ...
  if (not opticaOrtogonal) {
    ...
    // glm::perspective (FOV en radianes, ra window, znear, zfar)
    glm::mat4 Proj = glm::ortho(-radio * rav, radio * rav, -radio * rav, radio * rav, distancia-radio, distancia+radio);
    glUniformMatrix4fv (projLoc, 1, GL_FALSE, &Proj[0][0]);
  }
}
...
void MyGLWidget::viewTransform () {
    ...
    //glm::mat4 View = glm::lookAt (radioEscena, centroEscena, up);
...
void MyGLWidget::keyPressEvent(QKeyEvent* event) 
{
  ...
  switch (event->key()) {
    ...
    case Qt::Key_O: {
      opticaOrtogonal = !opticaOrtogonal;
      break;
    }
