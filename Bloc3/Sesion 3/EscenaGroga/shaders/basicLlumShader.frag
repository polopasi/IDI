...
{	
  ...
  vec3 L = normalize(posFocusEscena.xyz - vertexSCOShader.xyz);
	color += Difus (normSCO, L , colorFocusEscena) + Especular (normSCO, L, vertexSCOShader, colorFocusEscena);

  //FOCO CAMARA
  L = normalize(posFocusCamara.xyz - vertexSCOShader.xyz);
	color += Difus (normSCO, L , colorFocusCamara) + Especular (normSCO, L, vertexSCOShader, colorFocusCamara);
